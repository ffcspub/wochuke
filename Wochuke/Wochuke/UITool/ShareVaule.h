...
#define NOTIFICATION_SUPPLIERELOAD @"NOTIFICATION_SUPPLIERELOAD"
...
#define NOTIFICATION_CANNELEDIT @"NOTIFICATION_CANNELEDIT"
#define NOTIFICATION_SUPPLIESCELLWILLBEINGEDIT @"NOTIFICATION_SUPPLIESCELLWILLBEINGEDIT"
...
#define sinaWochukeId   @"3486482441"
