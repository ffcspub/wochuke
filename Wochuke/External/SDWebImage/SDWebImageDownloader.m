...
@synthesize url, delegate, connection, imageData, userInfo, lowPriority,totalDateLength,receiveDataLength;
...
- (void)connection:(NSURLConnection *)aConnection didReceiveData:(NSData *)data
{
    ...
    receiveDataLength = [imageData length];
    if ([delegate respondsToSelector:@selector(imageDownloaderDidReceiveData:)])
    {
        [delegate performSelector:@selector(imageDownloaderDidReceiveData:) withObject:self];
    }
}

- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)response{
    totalDateLength = [response expectedContentLength];
}
