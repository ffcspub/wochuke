...
- (void)initialize{
    ...
    _reusableCells = [[NSMutableDictionary alloc] initWithCapacity:0];
...
- (void)queueReusableCell:(UIView *)cell{
    [_reusableCells setObject:cell forKey:[cell class].description];
}
...
- (UIView *)dequeueReusableCell{
    UIView *cell = [_reusableCells.allValues lastObject];
    if (cell)
    {
        [_reusableCells removeObjectForKey:[cell class].description];
    }
    
    return cell;
}

- (UIView *)dequeueReusableCellWithClass:(Class)clazz{
    UIView *cell = [_reusableCells objectForKey:[clazz description]];
    if (cell){
        [_reusableCells removeObjectForKey:[clazz description]];
    }
    return cell;
}
